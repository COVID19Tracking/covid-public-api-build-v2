...
module.exports = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    states.forEach(({ state }) => {
      ...
      tasks.push(
        write(`states/${stateSlug}`, 'daily', {
          links: {
            self: `https://api.covidtracking.com/states/${stateSlug}/daily`,
          },
          ...schema,
      ...
      tasks.push(
        write(`states/${stateSlug}/daily`, 'simple', {
          links: {
            self: `https://api.covidtracking.com/v2/states/${stateSlug}/daily/simple`,
          },
          ...simplifiedSchema,
      ...
      tasks.push(
        write(`states/${stateSlug}`, 'current', {
          links: {
            self: `https://api.covidtracking.com/v2/states/${stateSlug}`,
          },
          ...simplifiedSchema,
      ...
      tasks.push(
        write(`states/${stateSlug}/current`, 'simple', {
          links: {
            self: `https://api.covidtracking.com/v2/states/${stateSlug}/current`,
          },
          ...simplifiedSchema,
      ...
      currentState.forEach((day) => {
        ...
        tasks.push(
          write(`states/${stateSlug}`, formattedDate, {
            links: {
              self: `https://api.covidtracking.com/states/${stateSlug}/${formattedDate}`,
            },
            ...schema,
        ...
        tasks.push(
          write(`states/${stateSlug}/${formattedDate}`, 'simple', {
            links: {
              self: `https://api.covidtracking.com/v2/states/${stateSlug}/daily/simple`,
            },
            ...simplifiedSchema,
